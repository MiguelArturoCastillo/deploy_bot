...
def get_response(message):
    ...
    response_list =[
        ...
        process_message(message,['01'],'Bien, podrias indicarnos si estas en un radio de 10 km'), 
        process_message(message,['Si','no','No','si'],'Bien, para pedir el servicio de grua, presiona 05'),       
        process_message(message,['01','02', '03', '04','05','06','07'],'Bien, en breve te contactaremos para coordinar el traslado, gracias.'),
